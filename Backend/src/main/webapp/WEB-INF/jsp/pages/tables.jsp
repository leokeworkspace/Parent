...
<head>
	...
	<!-- Timeline CSS -->
     ...
     <!-- jQuery -->
	<script type="text/ecmascript" src="resource/bower_components/jquery/dist/jquery.min.js"></script> 
	<script src="resource/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- We support more than 40 localizations -->
    <script src="resource/bower_components/jqGrid/js/i18n/grid.locale-tw.js"></script>
    <!-- This is the Javascript file of jqGrid -->   
    <script type="text/ecmascript" src="resource/bower_components/jqGrid/js/jquery.jqGrid.min.js"></script>
    <!-- This is the localization file of the grid controlling messages, labels, etc.
    <!-- A link to a jQuery UI ThemeRoller theme, more than 22 built-in and many more custom -->
	<link rel="stylesheet" href="resource/bower_components/jqGrid/css/bootstrap.min.css"> 
    <!-- The link to the CSS that the grid needs -->
    <link rel="stylesheet" type="text/css" media="screen" href="resource/bower_components/jqGrid/css/ui.jqgrid-bootstrap.css" />
	<script>
